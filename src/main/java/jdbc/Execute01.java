...
public class Execute01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
       ...
       Connection con= DriverManager.getConnection("jdbc:postgresql://localhost:5432/sql_practice","postgres","azraayse1981");
        ...
        //System.out.println(result);   // false return yapar cunku data çağırılmadı.
        ...
        // 5. Adım : Bağlantı ve Statmant'ı kapat.
        con.close();
        st.close();
